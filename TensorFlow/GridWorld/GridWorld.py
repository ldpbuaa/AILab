...
# defint the GridWorld Environment class
class gameEnv():
    ...
    def reset(self):
        ...
        goal2 = gameOb(self.newPosition(),1,1,1,1,'goal2')
        self.objects.append(goal2)
        hole2 = gameOb(self.newPosition(),1,1,0,-1,'hole2')
        self.objects.append(hole2)
        goal3 = gameOb(self.newPosition(),1,1,1,1,'goal3')
        self.objects.append(goal3)
        goal4 = gameOb(self.newPosition(),1,1,1,1,'goal4')
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes+1):
        ...
        rList.append(rAll)
        if i>0 and i % 25 == 0:
            print('episode',i,',averge reward of last 25 episode', np.mean(rList[-25:]))
        if i > 0 and i % 1000 == 0:
